            ...
            <div class="form">
                ...
                <form action="" class="form__content">
                    ...
                    <div class="form__div">
                        ...
                        <div class="form__div-input editForm">
                            <label for="" class="form__label">Enter Password again</label>
                            <input type="password" class="form__input">
                        </div>
                    </div>
                    <!-- Final RePassword -->
                    <a href="#" class="form__forgot">Already have account?</a>
                    <!-- <input type="submit" class="form__button bttn-fill bttn-md bttn-primary" value="Login"> -->
                    <button class="form__button bttn-fill bttn-md bttn-primary editBtn">Sign Up</button>
                    <!-- Login Method -->
                    <div class="form__social">
                        <span class="form__social-text">Another Method</span>
