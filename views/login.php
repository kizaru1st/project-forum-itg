    ...
    <div class="l-form">
            <div class="form">
                ...
                <form action="" class="form__content">
                    ...
                    <button class="form__button bttn-fill bttn-md bttn-primary editBtn">Login</button>
                    <!-- Login Method -->
                    <div class="form__social">
                        <span href="#" class="form__social-text">
                            <a href="#" class="form__forgot">Create new Account</a>Another Method
                        </span>
